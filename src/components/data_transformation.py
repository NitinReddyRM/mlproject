...
class DataTransformationConfig:
    preprocessor_obj_file_path: Path =os.path.join('artifacts','preprocessor.pkl')

class DataTransformation:
    def __init__(self):
        self.data_transmission_config=DataTransformationConfig()
        ...
        try:
            ...
            preprossor=ColumnTransformer(
                [
                    ...
                    ('obj_pipeline',obj_pipepine,object_columns)
                ]
            )
